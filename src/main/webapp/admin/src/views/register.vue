	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"flex-end","background":"#A5DDDD","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"0 0 20px","boxShadow":"0px 0px 0px 50px rgba(255,255,255,0.3000)","margin":"0","borderColor":"rgba(221,242,242,1)","borderRadius":"30px 0 0 0","background":"#fff","borderWidth":"30px 0 0 30px","width":"1500px","borderStyle":"solid","height":"800px"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"40px 0","margin":"0 0 30px 0","color":"#000","borderRadius":"0 0 30px 30px","textAlign":"center","background":"#A5DDDD","width":"100%","lineHeight":"1","fontSize":"20px","fontWeight":"bold"}' class="title">网上选课系统的设计与实现注册</div>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">工号</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">相片</div>
                    <file-upload
                        tip="点击上传相片"
                        action="file/upload"
                        :limit="3"
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					...
					<el-input  v-model="ruleForm.jiaoshidianhua"  autocomplete="off" placeholder="教师电话"  type="text"  />
				</el-form-item>
