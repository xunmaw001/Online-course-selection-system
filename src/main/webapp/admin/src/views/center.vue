<template>
  <div>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="工号" prop="gonghao">
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='jiaoshi'" label="相片" prop="xiangpian">
          <file-upload
          tip="点击上传相片"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="教师电话" prop="jiaoshidianhua">
