	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.xiangpian" label="相片" prop="xiangpian">
					<file-upload
						tip="点击上传相片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.xiangpian" label="相片" prop="xiangpian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="教师电话" prop="jiaoshidianhua">
					<el-input v-model="ruleForm.jiaoshidianhua" placeholder="教师电话" clearable  :readonly="ro.jiaoshidianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="教师电话" prop="jiaoshidianhua">
					<el-input v-model="ruleForm.jiaoshidianhua" placeholder="教师电话" readonly></el-input>
				</el-form-item>
			</template>
