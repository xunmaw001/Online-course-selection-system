	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="课程编号" prop="kechengbianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="考核成绩" prop="kaohechengji">
					<el-input v-model="ruleForm.kaohechengji" placeholder="考核成绩" clearable  :readonly="ro.kaohechengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="考核成绩" prop="kaohechengji">
					<el-input v-model="ruleForm.kaohechengji" placeholder="考核成绩" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="评语" prop="pingyu">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.pingyu" label="评语" prop="pingyu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.pingyu}}</span>
				</el-form-item>
